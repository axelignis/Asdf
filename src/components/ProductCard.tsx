  ...
  return (
    <article className="group">
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <button className="absolute inset-x-4 bottom-4 translate-y-3 rounded-full bg-charcoal/95 py-3 text-sm font-medium tracking-wide text-ivory opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100 hover:bg-gold-dark">
          Añadir al carrito
        </button>
      </div>
